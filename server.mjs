...
const EASYFLOW_EXTENSION_API_RE = /^\/api\/(?:infinity\/(?:payload\/[^/]+|mappings\/current|prepared-cases|autofill-log)|cases\/[^/]+\/(?:comparison-report|comparison-snapshot|capture(?:\/[^/]+)?|loan-form-note))\/?$/;
