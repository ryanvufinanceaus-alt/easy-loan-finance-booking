...
export function buildDocumentDraft(files = [], options = {}) {
  ...
  const manualSuggestions = [
    ...
    manualSuggestion("applicants.primary.gender", manualIntake.primaryGender, "Broker confirmed primary gender"),
    ...
    manualSuggestion("applicants.secondary.gender", manualIntake.secondaryGender, "Broker confirmed secondary gender"),
